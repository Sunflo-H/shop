...
export default function NextImage({ isTextAni }) {
  ...
  return (
    <section className="w-section relative transition-all mb-20  ">
      <div className=" max-w-screen md:max-w-banner max-h-screen md:max-h-banner bg-white overflow-hidden ">
        <div
          className={`w-screen h-screen md:w-banner md:h-banner bg-cover bg-no-repeat banner1 bg-left40 lg:bg-left opacity-80 xl:opacity-100 duration-200 `}
        ></div>
      </div>
