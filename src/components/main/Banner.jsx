  ...
  return (
    <section className="relative transition-all mb-20 ">
      <div className=" max-w-screen md:max-w-banner max-h-screen md:max-h-banner bg-white overflow-hidden ">
        <div className="w-screen h-screen md:w-banner md:h-banner bg-cover bg-no-repeat bg-banner animate-banner-img-sm md:animate-banner-img bg-left40 lg:bg-left opacity-80 lg:opacity-100 duration-200"></div>
      </div>
      <div className="absolute top-48 md:top-64  left-10 md:left-auto md:-right-2 ">
